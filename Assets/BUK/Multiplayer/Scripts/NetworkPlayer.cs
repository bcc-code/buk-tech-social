  ...
  public class NetworkPlayer : NetworkBehaviour
  {
    ...
    public void Start()
    {
      ...
      else
      {
        ...
        {
          // Local player should add it's ID to the recorder if we're using voice.
          var recorder = GameObject.FindObjectsOfType<Recorder>().First();
          if (recorder != null)
          {
            recorder.UserData = (int)netId;
            GetComponent<MirrorSpeakerLink>();
          }
